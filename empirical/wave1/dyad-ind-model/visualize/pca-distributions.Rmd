...
which(keyplayer_results$freq >= 35)
which(keyplayer_results$freq >= 36)
which(keyplayer_results$freq >= 37) #frequency of 36 gives the number closest to 300 nodes selected
...
p1_annot <- p1 + annotate("text", x=36, y=50, label="KP Cutoff")
p1_annot_seg <- p1_annot+annotate("segment", y=32, yend=42,
                                  x=36, xend=36)

p1_annot2 <- p1_annot_seg + annotate("segment", x=100, xend=100,
                                     y=210, yend=275 
                                     )
p1_annot3 <- p1_annot2+annotate("text", x=100, y=210, 
                                label="Other Cutoffs")
