...
p1_annot <- p1 + annotate("text", x=4, y=190, label="KP Cutoff")
p1_annot_seg <- p1_annot+annotate("segment", y=200, yend=210,
                                  x=4, xend=4)

p1_annot2 <- p1_annot_seg + annotate("segment", x=10, xend=10,
                                     y=210, yend=275 
                                     )
p1_annot3 <- p1_annot2+annotate("text", x=10, y=210, 
                                label="Other Cutoffs")
