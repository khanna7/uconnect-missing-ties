## compute eigenvector centrality scores on dyadic independent igraphs
   ...
   ## save 
   save.image(file="sort_top300_evcent_dyadic_ind_mod_base_13_100.RData")
   saveRDS(sort_top300_evcent_dyadic_ind_mod_base_13, file="top300_evcent_dyad_ind_100.RDS")   
