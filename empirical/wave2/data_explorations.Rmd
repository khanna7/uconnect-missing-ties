...
```{r}
par(mfrow=c(2,1))
barplot(w1_com_resp_net_w_w2svydata_esp_sum, ylim=c(0, 150), main="Wave 1")
barplot(w2_com_resp_net_wsvydata_esp_sum, ylim=c(0, 150), main="Wave 2")
```
...
```{r}
   par(mfrow=c(1,2))
   hist(deg_w1.fb.ig.10pc, breaks=seq(0, 800, 50), xlab="Degree", main="Wave 1")
   hist(deg_w2.fb.ig.10pc, breaks=seq(0, 800, 50), xlab="Degree", main="Wave 2")
```
...
```{r}
       par(mfrow=c(2,1))
       barplot(w1_gwesp_sum, ylim=c(0, 1200), main="Wave 1")
       barplot(w2_gwesp_sum, ylim=c(0, 1200), main="Wave 2")
```